...
import com.ahxiaodian.linquanapp.fragment.CustomFragment;
...
public class HomeActivity extends FragmentActivity implements OnClickListener{
	...
	protected void onNewIntent(Intent intent) {
		...
		case 2:
			...
			if (gj == null) {
				gj = HomeFragment
						.newInstance("http://www.99tx.com/wap/special.html?special_id=4",2);
		...
		case 3:
			...
			if (kf == null) {
				kf = CustomFragment
						.newInstance("http://wpa.qq.com/msgrd?v=3&uin=909972273&site=qq&menu=yes",3);
		...
		case 4:
			...
			if (gwc == null) {
				gwc = HomeFragment
						.newInstance("http://www.99tx.com/wap/tmpl/cart_list.html",4);
		...
		case 5:
			...
			if (grzx == null) {
				grzx = HomeFragment
						.newInstance("http://www.99tx.com/wap/tmpl/member/member.html?act=member",5);
